...
@section('content')
    <div class="wrapper flex flex-column just-cont-flex-start al-items-center">
        <div class="back-button flex flex-column just-cont-flex-start">
            <a href="{{route('admin.index')}}" class="btn btn-primary">@lang('public.back')</a>
        </div>
            ...
            <div class="tables-section">
                ...
                <table class="flex flex-column details">
                    ...
                    <tr>
                        ...
                        <td>{{$request->registerScholarship->id}}</td>
                    ...
                    <tr>
                        ...
                        <td>{{App::getlocale() == "en" ? $request->registerScholarship->status->name_en : $request->registerScholarship->status->name_ar}}</td>
                        <th>@lang('public.college')</th>
                        <td>{{App::getlocale() == "en" ? $request->registerScholarship->college->name_en : $request->registerScholarship->college->name_ar}}</td>
                    </tr>
                    <tr>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#approve-btn').click(function(e){
                ...
                $.ajax({
                    type: "POST",
                    url:"/admin/dashboard/extend/scholarship/approve",
                    data: {
                        _token: "{{ csrf_token() }}",
            ...
            $('#reject-btn').click(function(e){
                ...
                $.ajax({
                    type: "POST",
                    url:"/admin/dashboard/extend/scholarship/reject",
                    data: {
                        _token: "{{ csrf_token() }}",
                        request_id:  request_id,
