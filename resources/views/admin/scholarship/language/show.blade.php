            ...
            <div class="tables-section">
                ...
                <table class="flex flex-column details">
                    ...
                    <tr>
                        ...
                        <td>{{$request->user->date_of_joining_the_university}}</td>
                    ...
                    <tr class="contant-method">
                        <th>@lang('public.information_about_the_language_scholarship')</th>
                    </tr>
                    <tr>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#approve-btn').click(function(e){
                ...
                $.ajax({
                    type: "POST",
                    url:"/admin/dashboard/language/scholarship/approve",
                    data: {
                        _token: "{{ csrf_token() }}",
            ...
            $('#reject-btn').click(function(e){
                ...
                $.ajax({
                    type: "POST",
                    url:"/admin/dashboard/language/scholarship/reject",
                    data: {
                        _token: "{{ csrf_token() }}",
                        request_id:  request_id,
